  ...
  return (
    <div className="riding-page">
      ...
      <div className="info-container">
        <ElapsedTime onTimeWarning={handleTimeWarning} setElapsedTime={setElapsedTime} />
        <RideFare elapsedTime={elapsedTime} />
  
        <button className="end-ride-button" onClick={() => navigate("/")}>
          End Ride
        </button>
      </div>
      ...
      {showWarning && (
        <div className="warning-popup">
          <p>Your balance is low. Ride will end soon.</p>
        </div>
      )}
    </div>
  );
